...
public class Geners extends AppCompatActivity implements View.OnClickListener {
       ...
       ArrayList<File> myPhoneSongs;
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_geners);
        ...
        public void onClick(View v) {
            ...
            switch (id) {
                ...
                case R.id.btNext:
                    // I don't know how to derived position of clicked item
